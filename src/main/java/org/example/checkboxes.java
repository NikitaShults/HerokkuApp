...
public class checkboxes extends BaseTest {
    ...
    public void CheckboxesTest() {
        ...
        Assert.assertTrue(driver.findElements(By.cssSelector("[type=checkbox]")).get(1).isSelected(),
                "Checkbox is unchecked");
        driver.findElements(By.cssSelector("[type=checkbox]")).get(1).click();
        Assert.assertFalse(driver.findElements(By.cssSelector("[type=checkbox]")).get(1).isSelected(),
                "Checkbox is checked");
    }
}
